  ...
  const relicPresets: SeedPreset[] = [
    ...
    },
    {
      ...
      selection: {
        ...
        // Structure-chain roots + phosphates for battery / computronium root coverage (long run).
        lifetimeSec: 420,
        slots: [
          { kind: 'recipe', resourceId: 'refractories', durationSec: 60 },
          { kind: 'recipe', resourceId: 'metals', durationSec: 60 },
          { kind: 'recipe', resourceId: 'silicates', durationSec: 60 },
          { kind: 'recipe', resourceId: 'sulfides', durationSec: 60 },
          { kind: 'recipe', resourceId: 'oxides', durationSec: 60 },
          { kind: 'recipe', resourceId: 'volatiles', durationSec: 60 },
          { kind: 'recipe', resourceId: 'phosphates', durationSec: 60 },
          { kind: 'recipe', resourceId: 'regolithMass', durationSec: 60 },
        ],
        recipeStack: [
          'refractories',
          'metals',
